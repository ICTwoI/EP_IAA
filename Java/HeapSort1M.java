...
public class HeapSort1M {
    ...
    public static void main(String[] args) {
        ...
        String name = "1M_Array_";
        int cont = 1;

        try {

            fileWriter = new FileWriter("C:\\Users\\bruno\\Desktop\\EP\\HeapSort\\Resultados" + "1M_Resultados.txt");
            bufferedWriter = new BufferedWriter(fileWriter);

            while (cont <= 250) {
                int i = 0;

                fileReader = new FileReader("C:\\Users\\bruno\\Desktop\\EP\\HeapSort\\Arrays\\1M" + name + cont + ".txt");

...
public class HeapSort1K {
    ...
    public static void main(String[] args) {
        ...
        String name = "1K_Array_";
        int cont = 1;

        try {

            fileWriter = new FileWriter("C:\\Users\\bruno\\Desktop\\EP\\HeapSort\\Resultados" + "1K_Resultados.txt");
            bufferedWriter = new BufferedWriter(fileWriter);

            while (cont <= 250) {
                int i = 0;

                fileReader = new FileReader("C:\\Users\\bruno\\Desktop\\EP\\HeapSort\\Arrays\\1K" + name + cont + ".txt");

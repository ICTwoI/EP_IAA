...
public class HeapSort100K {
    ...
    public static void main(String[] args) {
        ...
        String name = "100K_Array_";
        int cont = 1;

        try {

            fileWriter = new FileWriter("C:\\Users\\bruno\\Desktop\\EP\\HeapSort\\Resultados" + "100K_Resultados.txt");
            bufferedWriter = new BufferedWriter(fileWriter);

            while (cont <= 250) {
                int i = 0;

                fileReader = new FileReader("C:\\Users\\bruno\\Desktop\\EP\\HeapSort\\Arrays\\100K" + name + cont + ".txt");
